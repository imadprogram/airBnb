                    ...
                    <table class="w-full text-left text-sm text-gray-600">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4"><span class="bg-blue-100 text-blue-700 py-1 px-3 rounded-full text-xs font-bold">Host</span></td>
                                <td class="px-6 py-4"><span class="bg-green-100 text-green-700 py-1 px-3 rounded-full text-xs font-bold">Active</span></td>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4"><span class="bg-gray-100 text-gray-700 py-1 px-3 rounded-full text-xs font-bold">Traveler</span></td>
                                <td class="px-6 py-4"><span class="bg-red-100 text-red-700 py-1 px-3 rounded-full text-xs font-bold">Banned</span></td>
                                <td class="px-6 py-4 text-right">
                                    <form action="../controllers/AdminController.php" method="POST">
